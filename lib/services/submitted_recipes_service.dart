    ...
    try {
      ...
      await DatabaseServiceCore.workerQuery(
        ...
        data: {
          ...
          'subject': 'Recipe Submission: LiverWise',
    ...
    try {
      ...
      await DatabaseServiceCore.workerQuery(
        ...
        data: {
          ...
          'subject': 'Recipe Submission Update - LiverWise',
          'userName': userName,
          'recipeName': recipeName,
          'message': '''
Dear $userName,

Thank you for submitting your recipe "$recipeName" to LiverWise!
...
We appreciate your contribution to the LiverWise community!
